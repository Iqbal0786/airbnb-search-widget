...
export default function SearchWidget() {
  ...
  //! search widget state
  const [showHideSearchWidget, setShowHideSearchWidget] = useState(false);
  ...
  const hideSearchWidget = () => {
    setShowHideSearchWidget(false);
  };
  useEffect(() => {
    if (typeof window !== "undefined") {
      window.onscroll = () => {
        const currentScrollPos = window.pageYOffset;
        // console.log('current scrol position', currentScrollPos)
  ...
  return (
    <>
      <AppBar
      elevation={1}
        sx={{  backgroundColor: "white", maxHeight:"160px", color: "black" ,
        transition:showHideSearchWidget?'maxHeight 250ms linear  ':'height 200ms '
      }}
      >
        <Toolbar
          sx={{
        ...
        >
          ...
          {!showHideSearchWidget ? (
            <Paper
              ...
              sx={{
                ...
                alignContent: "center",
                alignItems: "center",
                marginLeft: {xs:'5%',sm:'10%',md:"25%",lg:'25%'},
                cursor: "pointer",
              }}
              p={2}
            >
            ...
            <Box sx={{ width: "30%", height: "45px" }}>
              <Tabs
                ...
                centered
              >
                <Tab value="one" label="Stays" wrapped />
          ...
          >
            <Box  sx={{ cursor: "pointer", fontSize:'14px' , padding:'10px',borderRadius:'37px',"&:hover":{backgroundColor:'whitesmoke'} }}>Airbnb your home</Box>
            <Box sx={{width:'40px',height:'40px',display:'grid',borderRadius:'50%',placeItems:'center',"&:hover":{backgroundColor:'whitesmoke'}}}>
